...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './celItem.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CELITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CELITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CELITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CELITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CELITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CELITEM actions', async () => {
      const expectedActions = [
        {
